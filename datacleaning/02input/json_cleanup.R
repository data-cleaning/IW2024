...
# jsonlite has read it as a list, we have to supply simplifyVector = TRUE so
...
# 1 Look at the type and contents of the columns, discuss with your neighbour
...
# Assignment 6: Given at end of this session
