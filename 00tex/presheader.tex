...
\logo{
  ...
  \begin{tikzpicture}[remember picture, overlay]
    \node[xshift=13mm,yshift=3mm] at (current page.south west) {
        \includegraphics[height=5mm]{../00tex/logo-color-en-05.png}
    };
  \end{tikzpicture}
}
...
\setbeamertemplate{footline}{\hfill \texttt{www.markvanderloo.eu \phantom{fillup}}}
